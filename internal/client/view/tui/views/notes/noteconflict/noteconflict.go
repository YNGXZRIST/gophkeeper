// Package noteconflict resolves note sync conflicts and shows sync errors.
...
type item struct {
	id     string
	local  clientmodel.NoteData
	server clientmodel.NoteData
}
...
func line(d clientmodel.NoteData) string {
...
func decode(v *vault.Vault, blob []byte) clientmodel.NoteData {
