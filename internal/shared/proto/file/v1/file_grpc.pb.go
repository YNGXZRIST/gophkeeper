...
const (
	...
	FileService_Changes_FullMethodName    = "/file.v1.FileService/Changes"
)
...
func (c *fileServiceClient) Changes(ctx context.Context, in *ChangesRequest, opts ...grpc.CallOption) (*ChangesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChangesResponse)
	err := c.cc.Invoke(ctx, FileService_Changes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFileServiceServer) Changes(context.Context, *ChangesRequest) (*ChangesResponse, error) {
...
func _FileService_Changes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).Changes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_Changes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).Changes(ctx, req.(*ChangesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Changes",
			Handler:    _FileService_Changes_Handler,
		},
	},
